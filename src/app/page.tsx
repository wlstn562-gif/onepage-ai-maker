...
export default function Home() {
    ...
    useEffect(() => {
        ...
        // If not admin, redirect to /photo
        if (role !== 'admin') {
            ...
            <header className="mb-12 text-center relative w-full max-w-6xl">
                <div className="absolute right-0 top-0 hidden sm:block">
                    {isLoggedIn ? (
                        ...
                        <Link href="/login" className="text-xs font-bold text-zinc-400 hover:text-white transition-colors flex items-center gap-1 border border-zinc-700 hover:border-white px-3 py-1.5 rounded-full">
