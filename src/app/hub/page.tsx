        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-950 p-4 font-sans text-white">
            <header className="mb-12 text-center relative w-full max-w-6xl">
                ...
                <p className="mt-4 text-zinc-400">
                    크리에이터를 위한 올인원 AI 솔루션 (Internal Hub)
                </p>
                <div className="mt-4">
                    <Link href="/" className="text-sm text-zinc-500 hover:text-white transition-colors border-b border-zinc-700 hover:border-white pb-1">
                        ← 스튜디오 홈페이지로 돌아가기
                    </Link>
                </div>
            </header>
