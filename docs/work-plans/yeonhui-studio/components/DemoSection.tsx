  ...
  return (
    <div className="mt-32">
      <div className="flex flex-col items-center mb-12">
        <h2 className="text-5xl font-black text-center mb-4">Before & After Magic</h2>
        <div className="h-2 w-32 bg-black rounded-full"></div>
      </div>

      <div className="bg-white/40 p-4 md:p-12 rounded-[50px] border-4 border-white shadow-2xl">
            ...
            <div className="bg-white p-4 rounded-[40px] shadow-lg relative overflow-hidden group cursor-crosshair">
              <div className="relative aspect-[3/4] rounded-[30px] overflow-hidden">
                ...
                <div className="absolute top-6 left-6 flex gap-2">
                  <div className="bg-black text-white px-4 py-2 rounded-full font-black text-xs group-hover:hidden transition-all">BEFORE</div>
                  <div className="bg-accent-pink text-white px-4 py-2 rounded-full font-black text-xs hidden group-hover:block transition-all animate-pulse">AFTER (AI MAGIC)</div>
                </div>
              </div>
              ...
              <div className="bg-[#F8F9FA] rounded-[50px] overflow-hidden aspect-[9/19] flex flex-col relative">
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-6 p-6 mt-8">
                  ...
                  <div className="text-center">
                    <h5 className="text-xl font-black mb-1">Upload & Finish</h5>
                    <p className="text-gray-500 text-sm font-bold">Just 3 seconds away!</p>
                  </div>
